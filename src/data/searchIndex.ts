...
export function buildSearchIndex(): SearchEntry[] {
  ...
  const meets: SearchEntry[] = [
    { title: '28th Friendship Meet', subtitle: '2025 • Upcoming', href: '/friendship-meet', keywords: ['friendship', 'meet', 'upcoming', 'annual'] },
    { title: '27th Friendship Meet', subtitle: '2024 • Kuttalam', href: '/friendship-meet', keywords: ['friendship', 'meet', '2024', 'kuttalam'] },
    { title: '26th Friendship Meet', subtitle: '2023 • New Delhi', href: '/friendship-meet', keywords: ['friendship', 'meet', '2023', 'delhi'] },
  ]

  const humanitarian: SearchEntry[] = [
    { title: 'Medical Assistance', subtitle: 'Humanitarian Service', href: '/humanitarian-services', keywords: ['medical', 'assistance', 'humanitarian', 'support'] },
    { title: 'Educational Support', subtitle: 'Humanitarian Service', href: '/humanitarian-services', keywords: ['education', 'students', 'scholarship'] },
    { title: 'Food & Clothing', subtitle: 'Humanitarian Service', href: '/humanitarian-services', keywords: ['food', 'clothing', 'donation'] },
    { title: 'Livelihood Support', subtitle: 'Humanitarian Service', href: '/humanitarian-services', keywords: ['livelihood', 'support', 'family'] },
  ]

  const staticPages: SearchEntry[] = [
    { title: 'About Us', subtitle: 'Organisation Info', href: '/about', keywords: ['about', 'journey', 'values'] },
    { title: 'Contact', subtitle: 'Reach Out', href: '/contact', keywords: ['contact', 'email', 'phone'] },
    { title: 'Our Team', subtitle: 'Leadership & Volunteers', href: '/our-team', keywords: ['team', 'leadership', 'volunteers'] },
    { title: 'Homepage', subtitle: 'Indian Penpals\' League', href: '/', keywords: ['home', 'league', 'indian', 'penpals'] },
  ]
