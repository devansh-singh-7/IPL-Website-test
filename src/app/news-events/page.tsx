            ...
            <section className="container-custom mx-auto mt-8 mb-20">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {featuredEvents.map(item => (
                        <article key={item.id} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl border border-neutral-200 hover:border-neutral-300 transition-all duration-300 hover:-translate-y-1">
                ...
                {viewMode === 'grid' ? (
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {currentItems.map((item) => (
                            <article
                                key={item.id}
                                className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl border border-neutral-200 hover:border-neutral-300 transition-all duration-300 flex flex-col hover:-translate-y-1"
                            >
                                {/* Image header */}
                            ...
                            <div className="space-y-8">
                                {currentItems.map((item) => (
                                    <div key={item.id} className="relative flex gap-6">
                                        ...
                                        <div className="flex-1 bg-white rounded-2xl p-6 shadow-sm border border-neutral-200 hover:shadow-xl transition">
